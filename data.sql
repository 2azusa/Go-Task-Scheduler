...
(1, 'admin', 'admin', 'admin@example.com', 2, UNIX_TIMESTAMP(), 0),
(2, 'testuser', 'testuser', 'test@example.com', 1, UNIX_TIMESTAMP(), 0),
(3, 'john.doe', 'password123', 'john.doe@example.com', 1, UNIX_TIMESTAMP(), 0),
(4, 'jane.smith', 'password123', 'jane.smith@example.com', 1, UNIX_TIMESTAMP(), 0),
(5, 'alice', 'password123', 'alice@example.com', 1, UNIX_TIMESTAMP(), 0),
(6, 'bob', 'password123', 'bob@example.com', 1, UNIX_TIMESTAMP(), 0),
(7, 'charlie', 'password123', 'charlie@example.com', 1, UNIX_TIMESTAMP(), 0),
(8, 'david', 'password123', 'david@example.com', 1, UNIX_TIMESTAMP(), 0),
(9, 'emily', 'password123', 'emily@example.com', 1, UNIX_TIMESTAMP(), 0),
(10, 'frank', 'password123', 'frank@example.com', 1, UNIX_TIMESTAMP(), 0),
(11, 'grace', 'password123', 'grace@example.com', 1, UNIX_TIMESTAMP(), 0);
...
-- Records for jobs
-- ----------------------------
INSERT INTO `jobs` (`id`, `name`, `command`, `script_id`, `timeout`, `retry_times`, `retry_interval`, `job_type`, `http_method`, `notify_type`, `status`, `notify_to`, `spec`, `run_on`, `note`, `created`, `updated`) VALUES
